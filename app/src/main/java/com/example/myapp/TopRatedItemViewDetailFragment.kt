...
class TopRatedItemViewDetailFragment : Fragment() {
    ...
    private lateinit var TopRatedMoviePic : ImageView
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_top_rated_item_view_detail, container, false)

        TopRatedMoviePic = view.findViewById(R.id.itemViewImage)
    ...
    companion object {
        ...
        fun newInstance() = TopRatedItemViewDetailFragment()
    }
